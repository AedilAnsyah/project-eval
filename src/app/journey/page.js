          ...
          {timelineNodes.map((node, index) => {
            if (node.type === "month") {
              ...
              return (
                <div 
                  key={node.id}
                  className="relative h-20 flex justify-start md:justify-center items-center z-10 py-4"
                >
                  ...
                  <div 
                    ...
                    className="border-3 border-black px-6 py-2 rounded-xl shadow-neo-sm font-lilita text-base uppercase tracking-wider text-black select-none z-20 flex items-center gap-2 rotate-[-1deg] hover:scale-105 transition-transform duration-200 ml-12 md:ml-0"
                  >
                    <span>📅</span>
